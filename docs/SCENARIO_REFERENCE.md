...
This page documents the scenario format implemented by Faultora 0.10.1. The
...
```bash
java -jar faultora-0.10.1.jar validate --scenario scenario.yaml
```
...
| `message` | no | Reserved; 0.10.1 reports the assertion provider's evaluated message. |
