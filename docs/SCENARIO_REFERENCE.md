...
This page documents the scenario format implemented by Faultora 0.10.0. The
...
```bash
java -jar faultora-0.10.0.jar validate --scenario scenario.yaml
```
...
| `message` | no | Reserved; 0.10.0 reports the assertion provider's evaluated message. |
