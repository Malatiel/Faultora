 ...
 * <p>
 * So the rule is stated once, here: a runner advertises every version it can
 * speak, the dispatcher picks the highest it also speaks, and a pair with
 * nothing in common produces a <em>named refusal</em> rather than a connection
 * that fails somewhere later with a parse error.
 */
